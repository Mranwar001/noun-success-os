    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900">Book Summarizer</h2>
                    <p className="text-gray-500 text-sm">Upload course materials to get AI-powered chapter summaries.</p>
                </div>
            </div>
            ...
            {!summary ? (
                <div className="bg-white p-12 rounded-2xl shadow-sm border-2 border-dashed border-gray-200 flex flex-col items-center justify-center space-y-4">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-500">Only PDF documents are supported.</p>
                    </div>
                    ...
                    {file && (
                        <button
                            ...
                            disabled={processing}
                            className="mt-4 flex items-center space-x-2 bg-gray-900 text-white px-6 py-3 rounded-xl font-semibold hover:bg-black transition disabled:opacity-50"
                        >
                            {processing ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="md:col-span-2 space-y-6">
                        <div className="bg-white p-8 rounded-2xl shadow-sm border space-y-6">
                            <div className="flex justify-between items-center border-b pb-4">
                                <h3 className="text-xl font-bold text-gray-900">Chapter Summaries</h3>
                                <button
                            ...
                            {summary.chapters?.map((chapter: any, i: number) => (
                                <div key={i} className="space-y-2 animate-in fade-in slide-in-from-left-2" style={{ animationDelay: `${i * 100}ms` }}>
                                    <h4 className="font-bold text-primary-600 flex items-center space-x-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm border space-y-4 border-l-4 border-l-orange-500">
                            ...
                            <div className="space-y-3">
                                {summary.mockQuestions?.map((q: string, i: number) => (
                                    <div key={i} className="text-sm text-gray-600 bg-gray-50 p-4 rounded-xl border border-gray-100">
                                        {q}
                                    </div>
                                ))}
                            </div>
